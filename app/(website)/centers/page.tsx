          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 mt-14">
            ...
            {centers.map((center) => (
              ...
              >
                ...
                {/* Image Placeholder */}
                <div className="h-48 bg-gradient-to-r from-blue-700 to-cyan-600 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-14">
            ...
            <div className="bg-slate-50 rounded-3xl p-8 text-center">
              <Monitor className="w-14 h-14 text-blue-700 mx-auto" />
            ...
            <div className="bg-slate-50 rounded-3xl p-8 text-center">
              <Wifi className="w-14 h-14 text-blue-700 mx-auto" />
              <h3 className="mt-5 text-xl font-bold">
                High-Speed Internet
              </h3>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-8 text-center">
              <BookOpen className="w-14 h-14 text-blue-700 mx-auto" />
              <h3 className="mt-5 text-xl font-bold">
                Digital Library
              </h3>
            </div>
