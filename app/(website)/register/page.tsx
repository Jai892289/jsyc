    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-blue-50 to-cyan-50 py-14 px-6">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center">
          ...
          <span className="inline-flex rounded-full bg-blue-50 text-blue-700 px-4 py-2 text-sm font-medium border border-blue-100">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-12">
          ...
          >
            ...
            <div className="absolute top-0 left-0 h-1 w-full bg-gradient-to-r from-blue-700 to-cyan-500" />
